    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waiting_status', models.CharField(choices=[('waiting', '대기 중'), ('ready_to_confirm', '입장 확정 가능(관리자 호출)'), ('confirmed', '입장 확정'), ('arrived', '입장 완료'), ('canceled', '대기 취소')], default='waiting', max_length=20, verbose_name='대기 상태')),
